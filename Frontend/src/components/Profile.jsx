...
// Default profile image - use gradient instead
          ...
          <div className="p-6">
            ...
            <div className="flex flex-col items-center mb-6">
              <div className="relative">
                  ...
                  <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-green-500">
                    <img 
                      ...
                      onError={(e) => {
                        ...
                        e.target.parentElement.appendChild(getDefaultProfileIcon());
                      }}
                    />
                  </div>
                ) : (
                ...
                {isEditing && (
                  <label className="absolute bottom-0 right-0 bg-green-600 text-white rounded-full p-2 cursor-pointer shadow-md hover:bg-green-700 transition">
              ...
              <h3 className="font-bold text-xl mt-2">{user?.name || 'User'}</h3>
            </div>
